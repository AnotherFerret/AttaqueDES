...
Enfin, le script lance à nouveau l'exécution du programme avec comme argument la clé de taille 48 bits. Cet argument doit également être mis à jour.

Sorties : 
Le programme écrira dans le dossier "output" les valeurs de clés possible pour chaque chiffré fauté, par S-box.
( La comparaison pour retrouver la clé de 48 bits se fait manuellement pour le moment, elle sera automatisée si les délais de rendu du projet me le permettent ) 
